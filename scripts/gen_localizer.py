...
STRINGS = {
    ...
    "game.unavailable": ("Nu s-a putut pregăti nicio rundă pentru acest joc.", "Aucune manche n'a pu être préparée pour ce jeu.", "No round could be prepared for this game."),
    "game.retry":      ("Încearcă din nou", "Réessayer", "Try again"),
